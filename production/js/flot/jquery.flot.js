    ...
    function e(e, n, a, r) {
        ...
        function b() {
            ...
            for (t.each(d(), function(t, i) {
                ...
                }), e = 0; e < oi.length; ++e) r = oi[e], r.datapoints = {
                points: []
            ...
            for (e = 0; e < oi.length; ++e) {
                ...
                if (null == r.datapoints.pointsize) {
                    ...
                    for (r.xaxis.used = r.yaxis.used = !0, o = n = 0; o < p.length; ++o, n += c) {
                        ...
                        var y = null == u;
                        if (!y)
                            for (a = 0; c > a; ++a) h = u[a], f = m[a], f && (f.number && null != h && (h = +h, isNaN(h) ? h = null : 1 / 0 == h ? h = b : h == -1 / 0 && (h = -b)), null == h && (f.required && (y = !0), null != f.defaultValue && (h = f.defaultValue))), s[n + a] = h;
                        if (y)
        ...
        function S() {
            ...
            if (null == e)
                for (e = 0, i = 0; i < oi.length; ++i) e = Math.max(e, 2 * (oi[i].points.radius + oi[i].points.lineWidth / 2));
            var o = {
                left: e,
                right: e,
                top: e,
        ...
        function L() {
            ...
            if (a)
                for (t.isFunction(a) && (e = xi.getAxes(), e.xmin = e.xaxis.min, e.xmax = e.xaxis.max, e.ymin = e.yaxis.min, e.ymax = e.yaxis.max, a = a(e)), i = 0; i < a.length; ++i) {
                    var r = a[i],
                        l = N(r, "x"),
                        s = N(r, "y");
            ...
            function e(t, i, e) {
                for (var o = t.points, n = t.pointsize, a = Math.min(Math.max(0, e.min), e.max), r = 0, l = !1, s = 1, c = 0, h = 0;;) {
                    ...
                    if (null != f && null != d) {
                        ...
                        if (l || (si.beginPath(), si.moveTo(i.p2c(f), e.p2c(a)), l = !0), u >= e.max && p >= e.max) si.lineTo(i.p2c(f), e.p2c(e.max)), si.lineTo(i.p2c(d), e.p2c(e.max));
                        else if (u <= e.min && p <= e.min) si.lineTo(i.p2c(f), e.p2c(e.min)), si.lineTo(i.p2c(d), e.p2c(e.min));
                        else {
                            var m = f,
                                x = d;
        ...
        function V(t, i, e) {
            var o, n, a, r = ni.grid.mouseActiveRadius,
                l = r * r + 1,
                s = null;
        ...
        function K(t, i) {
            ...
            var o = Z(t, i); - 1 != o && (gi.splice(o, 1), U())
        }
